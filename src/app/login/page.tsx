    ...
    return (
        <div className="min-h-svh grid place-items-center bg-neutral-950 text-neutral-100">
            <main className="w-full max-w-md px-6 text-center space-y-6">
                ...
                {/* Bouton Spotify */}
                <Button onClick={() => signIn("spotify", { callbackUrl })} className="cursor-pointer inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium bg-emerald-500/90 hover:bg-emerald-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 transition">
